...
* Prototype: ```C void _puts_recursion(char *s);```
...
* Prototype: ```C void _print_rev_recursion(char *s);```
...
* Prototype: ```C int _strlen_recursion(char *s);```
...
This a function that returns the factorial of a given number.

* Prototype: ```C  int factorial(int n);```
...
* Prototype: ```C int _pow_recursion(int x, int y);```
...
This a function that returns the natural square root of a number.

* Prototype: ```C int _sqrt_recursion(int n);```
...
* Prototype: ```C int is_prime_number(int n);```
...
* Prototype: ```C int is_palindrome(char *s);```
...
* Prototype: ```C int wildcmp(char *s1, char *s2);```
